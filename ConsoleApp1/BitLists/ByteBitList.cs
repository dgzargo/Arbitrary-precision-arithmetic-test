...
public class ByteBitList : IList<bool>, IReadOnlyList<bool>
{
    ...
    {
        private readonly ByteBitList _byteBitList;
        private int _index;

        public BitEnumerator(ByteBitList byteBitList)
        {
            _byteBitList = byteBitList;
            _index = -1;
        }
        ...
        public bool MoveNext()
        {
            ...
            if (nextIndex >= _byteBitList.Count)
            {
                _index = _byteBitList.Count;
                return false;
            }
            _index = nextIndex;
            return true;
        ...
        public bool Current
        {
            get
            {
                ...
                if (_index >= _byteBitList.Count)
                    throw new InvalidOperationException("Enumeration already finished.");
                return _byteBitList[GetSubIndex(_index), GetOffset(_index)];
            }
        }
